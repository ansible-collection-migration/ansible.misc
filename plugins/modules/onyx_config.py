...
from ansible_collections.ansible.misc.plugins.module_utils.network.onyx.onyx import get_config
from ansible_collections.ansible.misc.plugins.module_utils.network.onyx.onyx import load_config
from ansible_collections.ansible.misc.plugins.module_utils.network.onyx.onyx import run_commands
